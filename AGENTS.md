...
| `skill: sync-agent-configs` | `.claude/skills/sync-agent-configs/SKILL.md` | Sync skill definitions to agent config files |
...
|------------|------|------|
| OpenAI | channel | `data/OpenAI/` |
| a16z | channel | `data/a16z/` |
| aie-code-2025 | channel | `data/aie-code-2025/` |
| anthropic-ai | channel | `data/anthropic-ai/` |
| aws-reinvent-2025 | channel | `data/aws-reinvent-2025/` |
| dwarkesh-patel | channel | `data/dwarkesh-patel/` |
| noduslabs | channel | `data/noduslabs/` |
| ryan-peterman | channel | `data/ryan-peterman/` |
| the-diary-of-a-ceo | channel | `data/the-diary-of-a-ceo/` |
| library-of-minds | manual | `data/library-of-minds/` |
| random | manual | `data/random/` |
